...
<body>
    ...
    <div class="kotak_login">
        <p class="tulisan_login">Silahkan melakukan log-in</p>
        <form action="tugas.php" method="POST">
            ...
            <p align="center"><input type="submit" value="Log-In" name="submit" id="submit" class="btn btn-primary btn-xl text-uppercase" align="center"></p>
            <br><br>
        </form>
    </div>
</body>
